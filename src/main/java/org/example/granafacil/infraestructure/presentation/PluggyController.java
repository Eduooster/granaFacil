...
public class PluggyController {
    ...
    public PluggyController(PluggyClientConnectionUseCase pluggyClientConnectionUseCase, PluggyClientItemUseCase pluggyClientItemUseCase, PluggyMapper pluggyMapper, SincronizarContaRepository sincronizarContaRepository, SincronizarTransacoesUseCase sincronizarTransacoesUseCase) {
